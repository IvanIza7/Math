...
export interface ProgressEvent {
  id: string;
  studentId: string;
  eventType: 'SESSION_COMPLETED' | 'TOPIC_STARTED' | 'TOPIC_COMPLETED' | 'TOPIC_MASTERED' | 'TRIAL_STARTED' | 'TRIAL_STEP_COMPLETED' | 'TRIAL_COMPLETED' | 'TRIAL_FAILED' | 'ILLEGAL_MOVE' | 'DEMO_COMPLETED' | 'BOSS_TRIAL_COMPLETED' | 'ATTENDANCE_REGISTERED' | 'PRACTICE_COMPLETED';
  entityId: string;
  timestamp: string;
  xpDelta?: number;
  metadata?: any;

...
export const ENCYCLOPEDIA_CARDS: EncyclopediaCard[] = [
  // Aritmética
  {
    ...
    teoria: [
      ...
      { title: 'Irracionales (I)', content: '\\text{Decimales \\textbf{infinitos sin patrón}, como } \\mathbf{\\pi} \\text{ o } \\mathbf{\\sqrt{2}}.', isLatex: true }
    ],
    ejemplos: [
      {
        ...
        steps: [
          ...
          'El 5 es un número Natural (N), por lo tanto también es Entero (Z) y Racional (Q).',
          'Respuesta: Es un número Racional.'
        ]
      },
      {
        problem: 'Identifica el valor posicional del 7 en 3,472.15',
        steps: [
          'Observamos la parte entera: 3,472',
          'El 2 son unidades, el 7 son decenas.',
          'Respuesta: El 7 representa 70 unidades o 7 decenas.'
        ]
      }
    ],
    tips: 'Todo entero "n" es una fracción con un 1 invisible como denominador: n = n/1.',
  ...
  },
  {
    ...
    teoria: [
      ...
      { title: 'm.c.m. vs M.C.D.', content: '\\text{\\textbf{m.c.m.}}(12, 18) = 36, \\quad \\text{\\textbf{M.C.D.}}(12, 18) = 6', isLatex: true },
  ...
  },
  {
    ...
    teoria: [
      { title: 'Probabilidad (Laplace)', content: 'P(A) = \\frac{\\text{\\textbf{Casos Favorables}}}{\\text{\\textbf{Casos Totales}}}', isLatex: true },
  ...
  },
  {
    ...
    teoria: [
      ...
      { title: 'Binomios Conjugados', content: '(a + b)(a - b) = a^2 - b^2 \\quad (\\text{\\textbf{Diferencia de Cuadrados}})', isLatex: true },
      { title: 'Término Común', content: '(x + a)(x + b) = x^2 + (a+b)x + ab \\quad (\\text{\\textbf{Trinomio} } x^2+bx+c)', isLatex: true },
  ...
  },
  {
    ...
    teoria: [
      ...
      { title: 'El Discriminante', content: '\\Delta = b^2 - 4ac. \\text{ Si } \\Delta > 0\\text{: \\textbf{2 sol.} } \\Delta = 0\\text{: \\textbf{1 sol.} } \\Delta < 0\\text{: \\textbf{Sin sol.} real.}', isLatex: true }
    ],
    ejemplos: [
      {
  ...
  },
  {
    ...
    tips: '¡Jamás canceles términos sumados en una fracción! En (x+5)/5 NO puedes tachar el 5 para dejar solo la x. Siempre factoriza primero.'
  },
  {
    id: 'vol2-t8',
    categoria: 'Álgebra',
  ...
  // Trigonometría
  {
    ...
    teoria: [
      ...
      { title: 'SOH CAH TOA', content: '\\text{\\textbf{Sen}}=\\frac{\\text{Op}}{\\text{Hip}}, \\quad \\text{\\textbf{Cos}}=\\frac{\\text{Ady}}{\\text{Hip}}, \\quad \\text{\\textbf{Tan}}=\\frac{\\text{Op}}{\\text{Ady}}', isLatex: true },
